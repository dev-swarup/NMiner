...
if (CMAKE_CXX_COMPILER_ID MATCHES GNU OR CMAKE_CXX_COMPILER_ID MATCHES Clang)
    ...
    set_source_files_properties(${RANDOMX_INCLUDE}/virtual_machine.cpp        PROPERTIES COMPILE_FLAGS "-fexceptions")
    ...
    set_source_files_properties(${RANDOMX_INCLUDE}/jit_compiler_x86.cpp       PROPERTIES COMPILE_FLAGS "-fexceptions")
    set_source_files_properties(${RANDOMX_INCLUDE}/jit_compiler_a64.cpp       PROPERTIES COMPILE_FLAGS "-fexceptions")
    set_source_files_properties(${RANDOMX_INCLUDE}/jit_compiler_rv64.cpp      PROPERTIES COMPILE_FLAGS "-fexceptions")
    set_source_files_properties(${RANDOMX_INCLUDE}/superscalar.cpp            PROPERTIES COMPILE_FLAGS "-fexceptions")
    set_source_files_properties(${RANDOMX_INCLUDE}/assembly_generator_x86.cpp PROPERTIES COMPILE_FLAGS "-fexceptions")
endif()
